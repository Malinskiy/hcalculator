...
#define __GMP_CC "/opt/tadp/android-ndk-r8d/toolchains/arm-linux-androideabi-4.7/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --sysroot=/opt/tadp/android-ndk-r8d/platforms/android-14/arch-arm -std=gnu99"
#define __GMP_CFLAGS "-UHAVE_LOCALE_H -O3 -pedantic -fomit-frame-pointer -Wa,--noexecstack -ffunction-sections -funwind-tables -fstack-protector -fno-strict-aliasing -finline-limit=64 -march=armv7-a -mfpu=neon -mfloat-abi=softfp -ftree-vectorize -ftree-vectorizer-verbose=2"
