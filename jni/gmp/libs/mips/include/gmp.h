...
#define __GMP_CC "/opt/tadp/android-ndk-r8d/toolchains/mipsel-linux-android-4.7/prebuilt/linux-x86/bin/mipsel-linux-android-gcc --sysroot=/opt/tadp/android-ndk-r8d/platforms/android-14/arch-mips"
#define __GMP_CFLAGS "-UHAVE_LOCALE_H -std=c99 -O3 -static -march=mips32"
