...
#define __GMP_CC "/opt/tadp/android-ndk-r8d/toolchains/x86-4.7/prebuilt/linux-x86/bin/i686-linux-android-gcc --sysroot=/opt/tadp/android-ndk-r8d/platforms/android-14/arch-x86 -std=gnu99"
#define __GMP_CFLAGS "-UHAVE_LOCALE_H -O3 -pedantic -fomit-frame-pointer -Wa,--noexecstack -ffunction-sections -funwind-tables -fstack-protector -fno-strict-aliasing -finline-limit=64 -march=i686"
